...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Text style={{position:'absolute',left:'6%',top:420,color:'#42207A',fontSize:25,fontWeight:'bold'}}>
      Are you a Customer or a Repair Station?
      </Text>
      
      <TouchableOpacity style={{ paddingVertical:2,borderColor:'#42207A',borderWidth:1, height:120, width:120, position:'absolute',top:'71%',left:'10%',borderRadius:5}}>
      <Image
      style={{position:'absolute', bottom:'10%',left:'20%', width:64,height:90}}
      source={require('./assets/images/a.png')}
      />
     </TouchableOpacity>
     <TouchableOpacity  style={{ paddingVertical:2,borderColor:'#42207A',borderWidth:1, height:120, width:120, position:'absolute',top:'71%',left:'60%',borderRadius:5}}>
      <Image
      style={{position:'absolute', bottom:'10%',left:'10%', width:95,height:90}}
